  ...
  head: () => ({
    meta: [
      ...
      { title: "Lock Lab — NFL & College Football Betting Analysis" },
      {
        name: "description",
        content:
          "Lock Lab runs NFL and college football matchups through one live formula: top 2 bets, supported props and one fun bet.",
      },
 ...
 * browser here, on `globalThis.__LOVABLE_PUBLIC_ENV__`. A Vite plugin points the
 * generated Supabase client's env fallback at that object. Only public values
      ...
      <div className="flex min-h-screen flex-col">
        ...
        <footer className="border-t border-hairline py-6">
          <p className="mx-auto max-w-6xl px-4 text-xs text-muted-foreground">
            Lock Lab is analysis and entertainment only. Bet responsibly — 21+ where legal.
          </p>
        </footer>
      </div>
      <Toaster />
